      ...
      <div class="card">
              <div class="card-header border-0">
                ...
                <div class="card-tools">
                    <a href="{{route('donateur.create')}}"> <button class="btn btn-primary"> Créer un donateur </button>  </a>
                </div>
              </div>
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <td>
                    <div class="row ">
                      <div class="">
                          <a href="{{ route('donateur.edit', $donateur->id) }}"> 
                            <span class="fas fa-edit"></span>
                          </a>
                      </div>
                      <div class="ml-4">
                        <form action="{{ route('donateur.destroy', $donateur->id) }}" method="post">
                          @method('DELETE')
                          @csrf
